  ...
  return (
    <section className="py-24 bg-transparent relative overflow-hidden">
      ...
      <SiteContainer className="relative z-10">
        <div className="rounded-2xl p-10 sm:p-14 liquid-glass-card glass-panel-dark liquid-shimmer text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10 text-left max-w-3xl mx-auto">
            ...
            <div className="flex items-start gap-3 p-4 rounded-xl bg-white/5 border border-white/5 sm:col-span-1">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2.5 px-8 py-3.5 glass-btn-gold text-[#0a0a0a] font-display text-xs tracking-widest uppercase font-bold rounded-xl transition-all group"
          >
